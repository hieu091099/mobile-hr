      ...
      >
        ...
        <View style={styles.tieude}>
          <Text style={[styles.td]}>
            Xin chào <Text style={{ fontSize: 35 }}>{userIdFromDevice}!</Text>
          </Text>
          <Text
        ...
        <View style={styles.form}>
          <TextInput
            theme={{
              colors: { primary: "#0D4A85", underlineColor: "transparent" },
            }}
          ...
          <View style={{ flexDirection: "row", alignItems: "flex-end" }}>
            <TouchableOpacity style={[styles.btndn]} onPress={() => login()}>
        ...
        <View style={styles.contact}>
          <View style={styles.contactItem}>
            <Icon name="phone-call" type="feather" color="#517fa4" size={20} />
            <Text style={styles.contactText}>028 3875 4536</Text>
          </View>
          <View style={styles.contactItem}>
            <Icon name="mail" type="feather" color="#517fa4" size={20} />
            <Text style={styles.contactText}>lactycom@lacty.com.vn</Text>
          </View>
        </View>
      </ImageBackground>
    </PaperProvider>
