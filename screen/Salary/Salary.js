    ...
    <View style={styles.wrapper}>
      ...
      {salary == "" ? (
        ...
        <View style={{ width: "93%", height: "100%" }}>
              ...
              <View style={styles.total1}>
                <View style={styles.totalMonth}>
                  <Text style={styles.textTitle}>
                    ...
                    >
                      {addZeroNumber(selectDate.split(" ")[1])} -{" "}
                      {selectDate.split(" ")[0]}
                    </Text>
                  </Text>
            ...
            {salary.Final_Salary == undefined ? (
              ...
              <>
                <View style={styles.total1}>
                  <View style={styles.threeColumn}>
                    <View style={styles.colunm}>
                      <Text style={styles.contentText}>Công TT</Text>
                      <Text style={styles.titleText}>
                        {salary?.Working_Days}
                      </Text>
                    </View>
                    <View style={styles.colunm}>
                      <Text style={styles.contentText}>T.Ca lũy kế</Text>
                      <Text style={styles.titleText}>{salary?.Overtime}</Text>
                    </View>
                    <View style={styles.colunm}>
                      <Text style={styles.contentText}>Loại bình bầu</Text>
                      <Text style={styles.titleText}>
                ...
                <View style={styles.total1}>
                  <View style={styles.threeColumn}>
                    <View style={styles.colunm}>
                      <Text style={styles.contentText}>Số phép năm</Text>
                      <Text style={styles.titleText}>
                        {salary?.Annual_Leave}
                      </Text>
                    </View>
                    <View style={styles.colunm}>
                      <Text style={styles.contentText}>Đã nghỉ</Text>
                      <Text style={styles.titleText}>{salary?.Leave_Days}</Text>
                    </View>
                    <View style={styles.colunm}>
                      <Text style={styles.contentText}>Còn lại</Text>
                      <Text style={styles.titleText}>
                        {salary?.Annual_Leave - salary?.Leave_Days}
                      </Text>
                    </View>
                  </View>
                </View>
          ...
          <Text style={styles.titleSalaryDetail}>Lương chi tiết </Text>
